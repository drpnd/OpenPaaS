...
class InstancesControllerTest < ActionController::TestCase
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post :create, instance: { host_id: @instance.host_id, ipaddr: @instance.ipaddr, name: @instance.name, repository_id: @instance.repository_id }
    end
  ...
  test "should update instance" do
    patch :update, id: @instance, instance: { host_id: @instance.host_id, ipaddr: @instance.ipaddr, name: @instance.name, repository_id: @instance.repository_id }
    assert_redirected_to instance_path(assigns(:instance))
  end
